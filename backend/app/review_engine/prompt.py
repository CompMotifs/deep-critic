...
class PROMPT(BaseModel):
    ...
    def __str__(self):
        ...
        return (
            ...
            '  "soundness": 5,     // Integer from 1-5 evaluating the theoretical/methodological soundness\n'
            '  "presentation": 4,  // Integer from 1-5 evaluating clarity and quality of writing\n'
            '  "contribution": 3,  // Integer from 1-5 evaluating significance of contributions\n'
            ...
            '  "rating": 7,        // Integer from 1-10 overall score (10 is highest)\n'
            '  "confidence": 4     // Integer from 1-5 confidence in your assessment\n'
            "}\n"
            "```\n\n"
