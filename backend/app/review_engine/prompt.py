...
class PROMPT(BaseModel):
    ...
    reviewer_supplementary_material: str = (
    ...
    q1_summary_statement: str = (
        "1. Summary and contributions: Summarize the paper motivation, key contributions and achievements in a paragraph."
    )
    ...
    q11_broader_impact_statement: str = (
        "11. Broader impact: Have the authors adequately addressed the broader impact of their work, including potential negative ethical and societal implications of their work? \n "
    ...
    q12_ethical_concerns_statement: str = (
        "12. Does the submission raise potential ethical concerns? "
